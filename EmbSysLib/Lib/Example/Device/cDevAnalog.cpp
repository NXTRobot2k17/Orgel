...
//===================================================================
  cDevDigital          led ( port1, 4, cDevDigital::Out, 0 );

  cDevAnalogInADC      in  ( adc,                        2, 3.3, 0.0 );
  cDevAnalogOutDAC     outA( dac,                        0, 3.3, 0.0 );
  cDevAnalogOutPWM     outB( timerPWM, cHwTimer::NORMAL, 3, 3.3, 0.0 );
  cDevAnalogOutPWMemul outC( timer,    led, 4/*bit*/,       3.3, 0.0 );
...
//===================================================================
  cDevDigital          led ( port, 15, cDevDigital::Out, 0 );

  cDevAnalogInADC      in  ( adc,                        0, 3.0, 0.0 );
  cDevAnalogOutDAC     outA( dac,                        1, 3.0, 0.0 );
  cDevAnalogOutPWM     outB( timerPWM, cHwTimer::NORMAL, 0, 3.0, 0.0 );
  cDevAnalogOutPWMemul outC( timer,    led, 4/*bit*/,       3.0, 0.0 );
