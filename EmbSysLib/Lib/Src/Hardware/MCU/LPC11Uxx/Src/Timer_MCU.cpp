...
extern "C" {
  ...
  {
    cHwTimer_N::timerCT16B0_Ptr->handler();
  }
}
...
extern "C" {
  ...
  {
    cHwTimer_N::timerCT16B1_Ptr->handler();
  }
}
...
extern "C" {
  ...
  {
    cHwTimer_N::timerCT32B0_Ptr->handler();
  }
}
...
extern "C" {
  ...
  {
    cHwTimer_N::timerCT32B1_Ptr->handler();
  }
}
